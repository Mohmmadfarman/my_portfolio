            ...
            <div className="container mx-auto flex flex-col md:flex-row items-center px-4 lg:px-0">
                ...
                >
                    <motion.h2
                        ...
                        whileInView={'show'}
                        viewport={{ once: false, amount: 0.7 }}
                        className="h2 font-bold mt-16 text-center md:text-left"
                    >
                        About me.
                    </motion.h2>
                    <motion.h3
                        ...
                        whileInView={'show'}
                        viewport={{ once: false, amount: 0.7 }}
                        className="text-xl mt-4 h3 mb-4 text-center md:text-left"
                    >
                    ...
                    >
                        I specialize in HTML, CSS, JavaScript, and modern frameworks React, crafting seamless digital experiences for clients. Passionate about clean code and innovative design, I continuously aim to enhance my skills and stay updated with the latest trends in web development.
                    </motion.p>
                    {/* Stats */}
                    <div className="mt-6 flex flex-col md:flex-row gap-4 sm:flex justify-start items-center">
                        <div className="text-[40px] font-tertiary text-gradient mb-2 text-center">
                            {inView ?
                                <CountUp start={0} end={1} duration={6} /> : null}
                        ...
                        {/* Second */}
                        <div className="text-[40px] font-tertiary text-gradient mb-2 text-center sm:text-[40px]">
                            {inView ?
                        ...
                        <div className="text-[40px] font-tertiary text-gradient mb-2 text-center">
                            {inView ?
                                <CountUp start={0} end={8} duration={6} /> : null}
                            <div className="font-primary text-[20px] tracking-[2px]">
                                Number of <br />
                                Skills
                            </div>
                    ...
                    <div className="flex flex-wrap max-w-max gap-x-6 items-center justify-center gap-4 mb-12 mt-12 mx-auto lg:mx-0 sm:mt-8">
                        <motion.button
                            ...
                            whileInView={'show'}
                            viewport={{ once: false, amount: 0.7 }}
                            className="btn btn-lg text-xl font-bold"
                        >
                            Contact Us
                        </motion.button>
                        <motion.a
