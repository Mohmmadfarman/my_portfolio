                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-y-8 lg:gap-x-12 relative z-30">
                    <div className="flex-1 text-center lg:text-left relative z-40">
                        ...
                        <div className="flex flex-wrap max-w-max gap-x-6 items-center justify-center gap-4 mb-12 mt-12 mx-auto lg:mx-0">
                            <a href={resume} download={resume} target="_blank">
                                <motion.button onClick={handleDownload}
                                    ...
                                    animate={animationDone ? "show" : "hidden"}
                                    viewport={{ once: true, amount: 0.7 }}
                                    className="btn btn-lg text-lg sm:text-xl font-bold flex flex-row justify-center items-center gap-5 px-6 py-2 mobile:text-[14px]">
                                    Download CV
                            ...
                            <motion.a
                                ...
                                animate={animationDone ? "show" : "hidden"}
                                viewport={{ once: true, amount: 0.7 }}
                                href="#" className="text-gradient btn-link text-2xl z-50 relative mobile:text-[23px]">My Portfolio</motion.a>
                        </div>
                        ...
                        <div
                            ...
                            <a href="https://github.com/Mohmmadfarman" target="_blank" rel="noopener noreferrer"><FaGithub className="md:text-4xl sm:text-[33px] mobile:text-[30px]" /></a>
                            <a href="#"><FaFacebook className="text-4xl sm:text-[33px] mobile:text-[30px]" /></a>
                            <a href="https://www.google.com" target="_black"><FaWhatsapp className="text-4xl sm:text-[33px] mobile:text-[30px]" /></a>
                            <a href="https://linkedin.com/in/mo-farman-88399224b" target="_blank" rel="noopener noreferrer"><FaLinkedin className="text-4xl sm:text-[33px] mobile:text-[30px]" /></a>
                        </div>
                    </div>
